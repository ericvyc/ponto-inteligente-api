...
import com.eric.pontointeligente.api.dto.LancamentoDto;
import com.eric.pontointeligente.api.entities.Funcionario;
import com.eric.pontointeligente.api.entities.Lancamento;
import com.eric.pontointeligente.api.enums.TipoEnum;
import com.eric.pontointeligente.api.services.FuncionarioService;
import com.eric.pontointeligente.api.services.LancamentoService;
...
public class LancamentoControllerTest {
	...
	public void testRemoverLancamentoAcessoNegado() throws Exception {
		BDDMockito.given(this.lancamentoService.buscarPorId(Mockito.anyLong())).willReturn(Optional.ofNullable(new Lancamento()));
